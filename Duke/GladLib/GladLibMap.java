...
/**
 * Trieda {@code GladLibMap} slúži «doplňte opis»…
 *
 * @author        {meno autora}
...
public class GladLibMap {
    ...
    public void makeStory(){
        ...
        printOut(story, 60);
        System.out.println("\n\nNumber of replaced word is: " + usedWordsList.size());
        System.out.println("Total number of words possible to pick from: " + totalWordsInMap());
